...
public OnPluginStart()
{
    ...
    g_max_give[2] = CreateConVar("sm_rifle_quota", "0", "Quota given to each player for obtaining rifle in each round (-1 = unlimited, 0 = disabled)");
    g_max_give[3] = CreateConVar("sm_hunting_rifle_quota", "0", "Quota given to each player for obtaining hunting_rifle in each round (-1 = unlimited, 0 = disabled)");
    g_max_give[4]= CreateConVar("sm_autoshotgun_quota", "0", "Quota given to each player for obtaining autoshotgun in each round (-1 = unlimited, 0 = disabled)");
    g_max_give[5] = CreateConVar("sm_pistol_quota", "0", "Quota given to each player for obtaining pistol in each round (-1 = unlimited, 0 = disabled)");
    g_max_give[6] = CreateConVar("sm_pipe_bomb_quota", "0", "Quota given to each player for obtaining pipe_bomb in each round (-1 = unlimited, 0 = disabled)");
    g_max_give[7] = CreateConVar("sm_molotov_quota", "0", "Quota given to each player for obtaining molotov in each round (-1 = unlimited, 0 = disabled)");
    g_max_give[8] = CreateConVar("sm_ammo_quota", "0", "Quota given to each player for obtaining ammo in each round (-1 = unlimited, 0 = disabled)");
    g_max_give[9] = CreateConVar("sm_pain_pills_quota", "0", "Quota given to each player for obtaining pain_pills in each round (-1 = unlimited, 0 = disabled)");
    g_max_give[10] = CreateConVar("sm_first_aid_kit_quota", "0", "Quota given to each player for obtaining first_aid_kit in each round (-1 = unlimited, 0 = disabled)");
